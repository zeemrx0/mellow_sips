...
abstract class StoreRepository {
  Future<AppPaginationListResultModel<StoreModel>> getStoreList({required Map<String, dynamic> params});
  Future<AppPaginationListResultModel<StoreModel>> searchStores({required Map<String, dynamic> params});
