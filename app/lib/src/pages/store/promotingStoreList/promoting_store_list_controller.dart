...
part 'promoting_store_list_page.dart';
part 'promoting_store_list_binding.dart';

class PromotingStoreListKey {
...
class PromotingStoreListController extends AppListViewController<StoreModel> {
  final GetPromotingStoreListUseCase _getPromotingStoreListUseCase;
  final GetDocumentUseCase _getDocumentUseCase;

  Rx<String> keyword = ''.obs;
  Rx<bool> isOpen = true.obs;

  PromotingStoreListController(
    this._getPromotingStoreListUseCase,
  ...
  Future<AppPaginationListResultModel<StoreModel>> onCall(
    ...
    final response = await _getPromotingStoreListUseCase.executePaginationList(
      param: GetPromotingStoreListParam(
